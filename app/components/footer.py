        ...
        children=[
            html.Div(
                ...
                children=[
                    ...
                    html.Span(
                        "European Commission / DG Regional and Urban Policy, Survey on the Quality of Life in European Cities, 2023"
                    ),
                ],
            ),
            html.Button(
...
def info_box(body=None):
    ...
    if body is None:
        body = dcc.Markdown(
            """
The dashboard uses data from the **Survey on the Quality of Life in European Cities** conducted by the European Commission / DG Regional and Urban Policy in 2023.
...
In line with the official reports, for each indicator I excluded the “don’t know/not answered” response category and reweighted the remaining categories, so the reported percentage shares refer to those respondents who provided a valid answer.
